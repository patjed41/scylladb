...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , join_ring(this, "join_ring", value_status::Used, true, "When set to true, a node will join the token ring. When set to false, a node will not join the token ring. This option cannot be changed after a node joins the cluster. It overwrites the num_tokens and initial_token options,")
