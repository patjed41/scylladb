...
if __name__ == "__main__":
    ...
    parser.add_argument("--key", action="store", required=True, help="Path to SSH private key file")
    args = parser.parse_args()

    # Initialize SSH client session using the provided node IP, user, and key path
